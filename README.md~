...
The software uses REST principles involving separating application into logical resources. These resources are manipulated using method (GET, POST, PUT, DELETE) that has specific meaning. The software demostrates how to build and deploy highly customizable, fully featured RESTful Web Services, that gives a properly content negotiated responses.
